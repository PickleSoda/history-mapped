...
- [ ] **Step 2: Run the targeted test to verify it fails if the facade is broken**
...
- [ ] **Step 3: Keep the test in place during refactor**
...
- [ ] **Step 1: Move shared helper functions and shared constants**
...
- [ ] **Step 2: Update imports in `stages.py` to use the common module**
...
- [ ] **Step 1: Run the core stage test suite**
Run: `py -m pytest pipeline/tests/test_ohm_borders_stages.py -v`
Expected: PASS

- [ ] **Step 2: Run relation stage tests**
...
- [ ] **Step 3: Run deadlock/build safety tests**
Run: `py -m pytest pipeline/tests/test_ohm_borders_deadlock_safety.py -v`
Expected: PASS

- [ ] **Step 4: If needed, run a narrow CLI smoke test**
