...
- [ ] **Step 1: Write XML index metadata tests**
...
- [ ] **Step 2: Write object-table schema tests**
...
- [ ] **Step 3: Write streaming ingest fixture tests**
...
- [ ] **Step 4: Write XML builder safety tests**
...
- [ ] **Step 5: Run the focused XML index tests to verify they fail**
...
- [ ] **Step 1: Implement the XML index schema and metadata helpers**
...
- [ ] **Step 2: Implement batched insert helpers for indexed OHM objects**
...
- [ ] **Step 3: Implement streamed XML ingest with `iterparse`**
...
- [ ] **Step 4: Implement temp-file build, atomic replace, and skipped-element diagnostics**
...
- [ ] **Step 5: Run the focused XML index tests to verify they pass**
Run: `py -m pytest pipeline/tests/test_ohm_collections_xml_index_store.py pipeline/tests/test_ohm_collections_xml_index_builder.py -v`
Expected: PASS.
...
- [ ] **Step 5: Write missing-geometry fallback tests**
Assert candidates with no usable OHM point return a no-point result rather than failing the whole workflow.

- [ ] **Step 6: Run the focused lookup and point tests to verify they fail**
...
- [ ] **Step 1: Implement normalized lookup helpers**
...
- [ ] **Step 2: Implement direct node-point resolution**
In `pipeline/ohm_collections/point_resolver.py`, return direct node coordinates immediately when available.

- [ ] **Step 3: Implement way/relation representative-point resolution**
...
- [ ] **Step 3: Write enrichment and fallback-coordinate tests**
...
- [ ] **Step 4: Write hybrid type-gating and weak-match rejection tests**
Assert incidental or weak mentions do not include conditional entities.

- [ ] **Step 5: Run the focused Egypt-rules tests to verify they fail**
...
- [ ] **Step 1: Implement Egypt vocabulary normalization and matching helpers**
Add explicit Egypt lexical families and normalized matching helpers in `pipeline/ohm_collections/egypt_rules.py`.

- [ ] **Step 2: Implement the candidate enrichment bridge**
...
- [ ] **Step 3: Implement hybrid type-gating and strong-link rules**
...
- [ ] **Step 4: Implement candidate scoring and decision reasons**
...
- [ ] **Step 5: Implement collection artifact path helpers**
Add `output/ohm_collections/<run_id>/...` helpers in `pipeline/ohm_collections/artifacts.py`.

- [ ] **Step 6: Run the focused Egypt-rules and enrichment tests to verify they pass**
Run: `py -m pytest pipeline/tests/test_ohm_collections_egypt_rules.py pipeline/tests/test_ohm_collections_entity_enricher.py -v`
Expected: PASS.
...
- [ ] **Step 1: Write border-backed routing tests**
...
- [ ] **Step 2: Write point-only generic routing tests**
...
- [ ] **Step 3: Write fallback-coordinate tests**
...
- [ ] **Step 1: Implement candidate assembly from XML lookup plus enrichment inputs**
...
- [ ] **Step 2: Route relation-backed polities into border artifacts**
...
- [ ] **Step 3: Route point-only or non-border entities into generic entity artifacts**
...
- [ ] **Step 4: Emit inclusion/exclusion reports and manifest counters**
...
- [ ] **Step 5: Run the focused builder tests to verify they pass**
Run: `py -m pytest pipeline/tests/test_ohm_collections_builder.py -v`
Expected: PASS.
...
- [ ] **Step 4: Add `egypt-relations-run` CLI coverage**
...
- [ ] **Step 5: Add `--resume` and `--force` command coverage**
...
- [ ] **Step 1: Run all new collection-focused test files**
...
- [ ] **Step 2: Run a collection smoke build from fixture XML**
...
- [ ] **Step 3: Run an Egypt collection smoke assembly from scratch**
...
- [ ] **Step 4: Re-run the collection assembly with `--resume`**
...
- [ ] **Step 5: Run Egypt relation generation from scratch**
...
- [ ] **Step 6: Re-run relation generation with `--resume`**
...
- [ ] **Step 7: Start the Laravel stack and stage collection artifacts into the import path**
...
- [ ] **Step 8: Verify border importer compatibility**
...
- [ ] **Step 9: Verify generic importer compatibility**
...
- [ ] **Step 10: Verify relation import compatibility**
...
- [ ] **Step 11: Verify relationship resolution and geometry-source provenance**
...
- [ ] **Step 5: Run focused doc-adjacent smoke verification**
