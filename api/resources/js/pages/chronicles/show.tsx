    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-6 p-4">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 text-sm text-muted-foreground">
                            ...
                            {chronicle.impact_score !== null &&
                                chronicle.impact_score !== undefined && (
                                    <Badge variant="outline">
                                        Impact {chronicle.impact_score}
                                    </Badge>
                                )}
                            {chronicle.approximate_location && (
                                <Badge variant="outline">
                                    {chronicle.approximate_location.lat.toFixed(
                                        1,
                                    )}
                                    ,{' '}
                                    {chronicle.approximate_location.lon.toFixed(
                                        1,
                                    )}
                                </Badge>
                            )}
                ...
                {/* Metadata */}
                {chronicle.metadata &&
                    Object.keys(chronicle.metadata).length > 0 && (
                                    ...
                                    <div className="mb-2 flex flex-wrap items-center gap-1.5 text-xs">
                                        ...
                                        <Badge variant="outline">
                                            ...
                                            <span className="mx-1 opacity-70">
                                                —
                                                {entry.primary_relationship.relationship_type?.replace(
                                                    /_/g,
                                                    ' ',
                                                ) ?? 'related'}
                                                →
            ...
            <Dialog open={confirmDelete} onOpenChange={setConfirmDelete}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Are you sure you want to delete "{chronicle.title}"?
