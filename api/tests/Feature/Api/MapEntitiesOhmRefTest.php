...
class MapEntitiesOhmRefTest extends TestCase
{
    use RefreshDatabase;

    public function test_ohm_linked_entity_emits_ref_and_point_geometry(): void
    {
        $entity = Entity::factory()->verified()->create();

        // A period with BOTH a point and a polygon, inside the bbox.
        DB::statement(
