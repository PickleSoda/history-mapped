...
class ChronicleController extends Controller
{
    ...
    private function serializeChronicle(Chronicle $chronicle): array
    {
        return [
            ...
            'start_year' => $chronicle->start_year,
            'end_year' => $chronicle->end_year,
            'impact_score' => $chronicle->impact_score,
            'approximate_location' => $chronicle->approximate_location,
            ...
            'entries' => $chronicle->relationLoaded('entries')
                ? $chronicle->entries->map(fn ($entry) => [
                    ...
                    'approximate_location' => $entry->approximate_location,
